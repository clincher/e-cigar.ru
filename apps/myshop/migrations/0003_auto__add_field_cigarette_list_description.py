...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cigarette.list_description'
        db.add_column('myshop_cigarette', 'list_description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Cigarette.list_description'
        db.delete_column('myshop_cigarette', 'list_description')
    ...
    models = {
        ...
        'myshop.cigarette': {
            ...
            'list_description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
